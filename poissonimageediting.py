...
def poisson_blend(src, mask, tar, method, output_dir):
  ...
  # 변경한 코드, (.mat파일명을 이미지명으로 구분)
  # if(os.path.isfile("{0}/"+img_name+".mat".format(output_dir))):
  #   A = scipy.io.loadmat("{}/"+img_name.format(output_dir))[img_name]
  #   # print("load coefficient matrix: A from .mat file\n")
  # else:
  #   A = coefficient_matrix(omega, mask, ngb_flag, yx_omega)
  #   scipy.io.savemat(output_dir+img_name".mat", A)
  #   # print("\n")
  A = coefficient_matrix(omega, mask, ngb_flag, yx_omega)
  scipy.io.savemat("{}/A".format(output_dir), {"A":A})
  # print("\n")
  ...
  # print("x_b, info_b done")
  x_g, info_g = sp.linalg.cg(A, u_g)
  # print("x_g, info_g done")
  x_r, info_r = sp.linalg.cg(A, u_r)
  # print("x_r, info_r done")
